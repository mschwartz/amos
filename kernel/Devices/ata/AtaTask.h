...
protected:
  // PIO
  TBool pio_read_sector(TIdeDevice *aIdeDevice, TUint64 aLba, TUint8 *aBuffer);
  TBool pio_read(TIdeDevice *aIdeDevice, TUint64 aLba, TUint8 *aBuffer, TInt aNumSectors);

  TBool pio_write_sector(TIdeDevice *aIdeDevice, TUint64 aLba, TUint8 *aBuffer);
  TBool pio_write(TIdeDevice *aIdeDevice, TUint64 aLba, TUint8 *aBuffer, TInt aNumSectors);
